...
CREATE TABLE `accounts` (
  ...
  `acc_phone` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `acc_password` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `acc_role` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user',
  PRIMARY KEY (`acc_id`),
...
INSERT INTO `accounts` VALUES ('ACC02','(086) 911-7530','7c222fb2927d828af22f592134e8932480637c0d','seller'),('ACC03','(032) 911-0540','239efe1121fa4e5483abfb2882a6b17eb2100c3a','user'),('ACC04','(034) 598-7377','7c222fb2927d828af22f592134e8932480637c0d','user'),('ACC05','(086) 985-6321','7c222fb2927d828af22f592134e8932480637c0d','user'),('ACC06','(086) 945-6321','7c222fb2927d828af22f592134e8932480637c0d','user');
...
INSERT INTO `brand` VALUES ('BRA30','6KU'),('BRA09','adidas'),('BRA02','AliveCor'),('BRA17','ALLPAIPAI'),('BRA14','Amazfit'),('BRA21','Arena'),('BRA41','Baden'),('BRA33','‎BV'),('BRA08','Callaway'),('BRA15','Carhartt'),('BRA28','Champion'),('BRA31','Cool Change'),('BRA01','Dickies'),('BRA12','Fitbit'),('BRA23','Franklin Sports'),('BRA38','GAMMA'),('BRA10','Gold Toe'),('BRA37','GoSports'),('BRA03','Hanes'),('BRA19','KNIPEX'),('BRA32','Malsooa'),('BRA06','Master Lock'),('BRA35','‎Mirrycle'),('BRA05','Nike'),('BRA22','NuLink'),('BRA36','‎‎Panther Vision'),('BRA16','PENN'),('BRA04','PUMA'),('BRA34','‎Schwinn'),('BRA25','Sena'),('BRA24','Shock Doctor'),('BRA11','Speedo'),('BRA20','STEARNS'),('BRA40','SuperStroke'),('BRA07','Thermajohn'),('BRA18','TYR'),('BRA39','Under Armour'),('BRA29','Unicycles'),('BRA27','Wilson'),('BRA26','YANYODO');
...
INSERT INTO `producer` VALUES ('PROD01','YANYODO'),('PROD02','Wilson'),('PROD03','California, United States'),('PROD04','Fun'),('PROD05','6KU'),('PROD06','Cool Change'),('PROD07','Malsooa'),('PROD08','Master Lock'),('PROD09','BV'),('PROD10','‎Pacific Cycle'),('PROD11','‎Mirrycle'),('PROD12','‎‎Panther Vision'),('PROD13','‎P&P Imports'),('PROD14','Nike'),('PROD15','GAMMA Sports'),('PROD16','Under Armour'),('PROD17','SuperStroke'),('PROD18','Baden');
...
-- Dump completed on 2023-05-06  0:02:54
